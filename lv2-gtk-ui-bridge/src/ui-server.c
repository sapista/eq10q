                                      ...
                                      const LV2_Feature* const* const features)
{
    ...
    if (strcmp(descriptor->URI, "http://eq10q.sourceforge.net/lv2-gtk2-ui-bridge") == 0)
    {
        bridge_tool = "eq10q-gtk2-ui-bridge" APP_EXT;
    }
    else
    {
    ...
    {
        snprintf(shm_name, sizeof(shm_name) - 1, "eq10q-gtk-ui-bridge-%d", i + 1);
    ...
    if (bridge->ipc == NULL)
    {
        fprintf(stderr, "[eq10q-gtk-ui-bridge] ipc_server_start failed\n");
        free(bridge);
        return NULL;
    }
    ...
    fprintf(stderr, "[eq10q-gtk-ui-bridge] ipc_server_start failed to fetch initial response\n");
...
const LV2UI_Descriptor* lv2ui_descriptor(const uint32_t index)
{
    static const LV2UI_Descriptor descriptor_gtk2 = {
        .URI = "http://eq10q.sourceforge.net/lv2-gtk2-ui-bridge",
    ...
    case 1: return NULL; //Removed GTK3 stuff
    default: return NULL;
    }
}
